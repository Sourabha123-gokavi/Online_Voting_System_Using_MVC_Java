...
<html>
            <head>
                ...
                <style>
                    body {
                        background-image: url('https://www.dekhnews.com/wp-content/uploads/2015/07/Narendra-Modi-Arvind-Kejriwal-Rahul-Gandhi-Caricature.jpg');
                    ...
                    <tr>
                        ...
                        <td>
                            <a class="btn btn-danger"
                                href="/Online-Voting-System/party/deleteParty/${party.partyId}">Delete</a>
                        </td>
                    </tr>
                </c:forEach>
            </tbody>
        </table>
        <a class="btn btn-primary add-button" href="/Online-Voting-System/party/add">Add More Parties</a>
